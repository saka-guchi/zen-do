...
features:
  - title: ⚡️ 徹底的な軽量化
    details: 必要な機能だけを厳選。無駄なUIや重い常駐プロセスを排除し、あなたの思考とPCのパフォーマンスを妨げません。
  - title: 🆓 コア機能は無料で提供
    details: ツール群の基本機能はオープンソースとしてGitHubで公開。誰でも無料で使い始めることができます。
  - title: 🤖 シームレスなAI体験
    details: いつもの操作を阻害することなく、必要な瞬間にだけローカルまたはクラウドのAIパワーを呼び出せる設計思想。
---

<h2 id="products" style="text-align: center; margin-top: 4rem; margin-bottom: 2rem;">プロダクト</h2>

### <img src="/assets/zenclip/logo.png" class="themed-logo light-only" alt="ZenClip Logo" /><img src="/assets/zenclip/logo-white.png" class="themed-logo dark-only" alt="ZenClip Logo" /> [ZenClip](/ja/zenclip)
...
### 📷 [ZenCull](/ja/zencull) (Coming Soon)

大量のRAWデータから、AIのアシストと洗練されたUIで「残すべき1枚」を瞬時にピックアップする、フォトグラファー向け高速写真選別ツール。